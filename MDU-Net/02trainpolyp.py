...
def train(train_loader, model, optimizer, epoch, best_loss):
    ...
    if (epoch + 1) % 1 == 0:
        torch.save(model.state_dict(), save_path + 'UCRNet10_2.pth')
        print('[Saving Snapshot:]', save_path + 'UCRNet10_2-%d.pth' % epoch)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_save', type=str, default='kUCRNet10_2')
