...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path', type=str,
                        default='polyp/UCRNet10_3/UCRNet10_3.pth')  # 'snapshots/TransFuse-19_best.pth'
    parser.add_argument('--test_path', type=str,
                        default='data/', help='path to test dataset')
    parser.add_argument('--save_path', type=str, default=None, help='path to save inference segmentation')#''zhijia/result2/uarn5'
    ...
    for i in range(test_loader.size):
        ...
        total_f1.append(f1)"""
    sys.stdout = open("zhijiaiouloss.txt", "a+")
